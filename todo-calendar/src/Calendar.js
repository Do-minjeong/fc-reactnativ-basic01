...
export default ({columns, selectedDate, onPressLeftArrow, onPressHeaderDate, onPressRightArrow, onPressDate, todoList}) => {
            ...
            <View>
                ...
                <View style={{ flexDirection: "row" }}>
                    {[0, 1, 2, 3, 4, 5, 6].map(day => {
                        ...
                        return (
                            <Column key={`day-${day}`} text={dayText} color={dayColor} opacity={1} disabled={true} />
                        )
                    })}
                </View>
            </View>
    ...
    const renderItem = ({ item: date }) => {
        ...
        return (
            <Column 
                ...
                onPress={onPress} isSelected={isSelected} 
                hasTodo={hasTodo}
            />
        )
    }
